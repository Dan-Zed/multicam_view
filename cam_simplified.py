...
def gen_frames():
    ...
    while True:
        try:
            ...
            if frame_count % 50 == 0:
                gc.collect()
                logger.info(f"Frame rate: {50/(current_time-last_time):.1f} fps")
            ...
            # Comment out for troubleshooting if freezing occurs
            ...
            # Sleep to reduce frame rate and CPU usage
            ...
            try:
                ...
                draw.text((320, 240), f"Frame Error", fill=(255, 0, 0))
                img_io = io.BytesIO()
